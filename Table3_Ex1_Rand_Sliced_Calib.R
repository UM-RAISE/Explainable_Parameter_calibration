...
# example
name = "schwef" # schwef (example1), ackley (example2), hart3 (example3)
func = schwef

# method: A_Ex_Sliced_Calib, A_Rand_Sliced_Calib, A_Full_Calib, A_TR_Calib
method = "A_Rand_Sliced_Calib"
...
table[1,colnames(table) == c("theta1 (mean)")] = table[1,colnames(table) == c("theta1 (mean)")]*(500-(-500))-500
table[1,colnames(table) == c("theta2 (mean)")] = table[1,colnames(table) == c("theta2 (mean)")]*(500-(-500))-500
table[1,colnames(table) == c("theta3 (mean)")] = NA

table[1,colnames(table) == c("theta1 (std)")] = table[1,colnames(table) == c("theta1 (std)")]*(500-(-500))
table[1,colnames(table) == c("theta2 (std)")] = table[1,colnames(table) == c("theta2 (std)")]*(500-(-500))
